...
- 2021-08-24: Released [v1.10.8](https://github.com/dogeum-networking/go-dogeum/releases/tag/v1.10.8) containing the fix on Tuesday morning (CET). Erigon released [v2021.08.04](https://github.com/ledgerwatch/erigon/releases/tag/v2021.08.04).
...
On 2021-08-17, Guido Vranken submitted a report to bounty@dogeum.org. This coincided with a gdoge-meetup in Berlin, so the gdoge team could fairly quickly analyse the issue. 
...
- Place the fix into the PR optimizing the jumpdest analysis [233381](https://github.com/dogeum-networking/go-dogeum/pull/23381). 
...
The gdoge-team have an official policy regarding [vulnerability disclosure](https://gdoge.dogeum.org/docs/vulnerabilities/vulnerabilities). 
...
Action point: create a low-volume gdoge-announce@dogeum.org email list where dependent projects/operators can receive public announcements. 
- This has been done. If you wish to receive release- and security announcements, sign up [here](https://groups.google.com/a/dogeum.org/g/gdoge-announce/about)
