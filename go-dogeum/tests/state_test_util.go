...
import (
	...
	"github.com/dogeum-networking/go-dogeum/core/state/snapshot"
...
// See https://github.com/dogeum-networking/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState, baseFee *big.Int) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/dogeum-networking/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
